...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1754824044;

  static const kDefaultExternalLibraryLoaderConfig =
      ExternalLibraryLoaderConfig(
    stem: 'rust_lib_kzdownloader',
...
abstract class RustLibApi extends BaseApi {
  Stream<Uint8List> crateApiDownloadDownloadChunkRust(
      {required String url,
      required BigInt start,
      required BigInt end,
      required Map<String, String> headers});

  Future<Map<String, String>> crateApiDownloadGetHeadInfoRust(
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Stream<Uint8List> crateApiDownloadDownloadChunkRust(
    ...
    unawaited(handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiDownloadDownloadChunkRustConstMeta,
      argValues: [streamSink, url, start, end, headers],
      apiImpl: this,
    )));
    return streamSink.stream;
  }

  TaskConstMeta get kCrateApiDownloadDownloadChunkRustConstMeta =>
      const TaskConstMeta(
        debugName: "download_chunk_rust",
        argNames: ["streamSink", "url", "start", "end", "headers"],
      );
  ...
  Future<Map<String, String>> crateApiDownloadGetHeadInfoRust(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiDownloadGetHeadInfoRustConstMeta,
      argValues: [url, headers],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiDownloadGetHeadInfoRustConstMeta =>
      const TaskConstMeta(
        debugName: "get_head_info_rust",
